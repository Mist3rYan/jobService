 ...
 */
final class Version20230321113653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, recruteur_id INT NOT NULL, poste VARCHAR(255) NOT NULL, lieu_de_travail VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, create_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', id_candidat_valid LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', id_candidat_invalid LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', id_candidat_attente LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', id_validaton_consultant VARCHAR(255) DEFAULT NULL, is_valid TINYINT(1) NOT NULL, INDEX IDX_F65593E5BB0859F1 (recruteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
